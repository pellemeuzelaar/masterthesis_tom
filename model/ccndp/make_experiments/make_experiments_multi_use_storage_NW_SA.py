...
def make_experiment():
    ...
    # Storage node data
    storage = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Storage/NW/Storage_NW_SA_3.csv")
...
def main():
    ...
    data.to_file("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Instances/STORAGE_MULTI_NW_saf_SA_3.json")
