...
def make_experiment():
    ...
    # Facility node data
    conversion = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Facilities/SE/SE_FINAL_ALL_USES.csv")
    conversion = pd.DataFrame(conversion)

    # Demand node data
    consumption = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Demand/SE/Demand_SE_ALL_USES.csv")
    ...
    supply = emitters.iloc[:,4:].values/1000000 # Is in kg Convert to Mton
    ...
    for fac in urea_facilities:
        ...
        cost_per_ton_urea = 284830000 #458.47 per ton
    ...
    for fac in methanol_facilities:
        # Conversion costs in euro per tonne CO2 for each end-use
        cost_per_ton_methanol = 431210000 #700.63 per ton
    ...
    for fac in saf_facilities:
        # Conversion costs in euro per tonne CO2 for each end-use
        cost_per_ton_saf = 116940000 #190.00 per ton
...
def main():
    ...
    data.to_file("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Instances/BASE_MULTI_SE_SA_58.json")
