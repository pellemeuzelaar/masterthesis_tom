...
def make_experiment():
    ...
    # Storage node data
    storage = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Storage/SE/StorageSE_SA_3.csv")
    storage = pd.DataFrame(storage)

    # The values inputted for different nodes imported from dataframe
    supply = emitters.iloc[:,4:].values/1000000 # Is in Kt Convert to Mton
...
def main():
    ...
    data.to_file("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Instances/STORAGE_MULTI_SE_saf_SA_3.json")
