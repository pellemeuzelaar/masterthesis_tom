...
def make_experiment():
    ...
    for fac in urea_facilities:
        ...
        cost_per_ton_urea = 346120000 #458.47 per ton
    ...
    for fac in methanol_facilities:
        # Conversion costs in euro per tonne CO2 for each end-use
        cost_per_ton_methanol = 528930000 #700.63 per ton
    ...
    for fac in saf_facilities:
        # Conversion costs in euro per tonne CO2 for each end-use
        cost_per_ton_saf = 143440000 #190.00 per ton
...
def main():
    ...
    data.to_file("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Instances/2_MULTI_UK_SA.json")
