...
def make_experiment():
    ...
    supply = emitters.iloc[:,4:].values/1000000 # Is in ton Convert to Mton
    ...
    for fac in urea_facilities:
        ...
        cost_per_ton_urea = 458470000 #458.47 per ton
    ...
    for fac in methanol_facilities:
        # Conversion costs in euro per tonne CO2 for each end-use
        cost_per_ton_methanol = 700630000 #700.63 per ton
    ...
    for fac in saf_facilities:
        # Conversion costs in euro per tonne CO2 for each end-use
        cost_per_ton_saf = 190000000 #190.00 per ton
...
def main():
    ...
    data.to_file("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Instances/BASE_MULTI_SE_V2.json")
