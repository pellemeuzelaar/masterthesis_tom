...
#  CO2 emissions data
df = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Storage/NW/Storage_NW.csv")
...
# Display the map
m.save("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Results/storagesNW.html")
