...
def main():
    # Opening files
    f = open("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Results/2_MULTI_DK_SA.json")
    emitters = pd.read_csv(
        "/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Emitters/NW/AllEmittersDK(kg:y).csv")
    conversion = pd.read_csv(
        "/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Facilities/NW/Facilities_DK.csv")
    consumption = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Demand/NW/Demand_NW_DK.csv")
    storage = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Storage/NW/Storage_DK.csv")
    ...
    fac_capacity = [1 for i in range(num_fac)]
    counter_list = []
    name = []
    ...
    counter_list = []
    amount_supplied = []
    supplied = emitters["TotalQuantity (kg/year)"]
