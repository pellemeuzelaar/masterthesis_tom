...
def main():
    ...
    # Opening files
    f = open("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Results/STORAGE_MULTI_NW_saf_SA.json")
    ...
    strg_decisions = [284, 313, 314, 333, 340, 342, 369, 309, 310, 352, 381]
    ...
    # Save the map
    m.save("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Results/STORAGE_SINGLE_NW_saf.html")
