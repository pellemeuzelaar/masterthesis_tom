...
def main():
    ...
    # Opening files
    f = open("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Results/BASE_MULTI_GR_V2.json")
    emitters = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Emitters/SE/AllEmittersGR(t:y).csv")
    conversion = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Facilities/SE/SE_ALL_FAC_GR.csv")
    consumption = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Demand/SE/Demand_SE_ALL_GR.csv")
    storage = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Storage/SE/StorageGR.csv")
    ...
    # Save the map
    m.save("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Results/BASE_MULTI_GR_V2.html")
