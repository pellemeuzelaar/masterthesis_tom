...
def main():
    # Opening files
    f = open("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Results/STORAGE_MULTI_SE_methanol.json")
    ...
    conversion = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Facilities/SE/SE_FINAL_methanol.csv")
    consumption = pd.read_csv("/Users/pellemeuzelaar/PycharmProjects/Thesis_V3/model/data/Demand/SE/Demand_SE_Methanol_V2.csv")
    ...
    print("Total percentage captured: ", total_emissions_captured/sum(emitters["TotalQuantity(tons/y)"]))
